...
@interface JianKangZhanViewController ()

@end

@implementation JianKangZhanViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    //navigation
    self.navigationController.navigationBar.barTintColor = [UIColor whiteColor];
    self.navigationItem.title = @"心理健康站";
    ...
    // 2.1 创建一个远程URL
    NSURL *remoteURL = [NSURL URLWithString:@"https://www.psy.com.cn/"];
